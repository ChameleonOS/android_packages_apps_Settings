...
package com.android.settings.cosstats;
...
public class AnonymousStats extends SettingsPreferenceFragment
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mEnableReporting) {
            ...
            Uri uri = Uri.parse("http://stats.chameleonos.org");
    ...
    public void onClick(DialogInterface dialog, int which) {
        if (which == DialogInterface.BUTTON_POSITIVE) {
            ...
            Uri uri = Uri.parse("http://www.chameleonos.org/blog/cosstats-what-it-is-and-why-you-should-opt-in");
            startActivity(new Intent(Intent.ACTION_VIEW, uri));
        }
    }
